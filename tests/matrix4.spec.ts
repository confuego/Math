...
describe("Matrix4", () => {
	...
	it("should calculate the identity", () => {
		...
		expect(mat.get(0, 3)).to.be.equal(0);
		expect(mat.get(1, 0)).to.be.equal(0);
		expect(mat.get(1, 1)).to.be.equal(1);
		expect(mat.get(1, 2)).to.be.equal(0);
		expect(mat.get(1, 3)).to.be.equal(0);
		expect(mat.get(2, 0)).to.be.equal(0);
		expect(mat.get(2, 1)).to.be.equal(0);
		...
		expect(mat.get(3, 1)).to.be.equal(0);
		expect(mat.get(3, 2)).to.be.equal(0);
		expect(mat.get(3, 3)).to.be.equal(1);
	});

	it("should calculate the orthographic projection", () => {
		const mat = Matrix4.ortho(1, 2, 3, 4, 5, 6);

		expect(mat.get(0, 0)).to.be.equal(2);
		expect(mat.get(0, 1)).to.be.equal(0);
		expect(mat.get(0, 2)).to.be.equal(0);
		expect(mat.get(0, 3)).to.be.equal(-3);
		expect(mat.get(1, 0)).to.be.equal(0);
		expect(mat.get(1, 1)).to.be.equal(2);
		expect(mat.get(1, 2)).to.be.equal(0);
		expect(mat.get(1, 3)).to.be.equal(-7);
		expect(mat.get(2, 0)).to.be.equal(0);
		expect(mat.get(2, 1)).to.be.equal(0);
		expect(mat.get(2, 2)).to.be.equal(-2);
		expect(mat.get(2, 3)).to.be.equal(-11);
		expect(mat.get(3, 0)).to.be.equal(0);
		expect(mat.get(3, 1)).to.be.equal(0);
		expect(mat.get(3, 2)).to.be.equal(0);
		expect(mat.get(3, 3)).to.be.equal(1);
	...
	it("should calculate the perspective projection", () => {
		const mat = Matrix4.pers(10, 1, 2, 3);

		expect(mat.get(0, 0)).to.be.closeTo(3.810017, 0.000001);
		expect(mat.get(0, 1)).to.be.equal(0);
		expect(mat.get(0, 2)).to.be.equal(0);
		expect(mat.get(0, 3)).to.be.equal(0);
		expect(mat.get(1, 0)).to.be.equal(0);
		expect(mat.get(1, 1)).to.be.closeTo(11.43004, 0.0001);
		expect(mat.get(1, 2)).to.be.equal(0);
		expect(mat.get(1, 3)).to.be.equal(0);
		expect(mat.get(2, 0)).to.be.equal(0);
		expect(mat.get(2, 1)).to.be.equal(0);
		expect(mat.get(2, 2)).to.be.equal(-3);
		expect(mat.get(2, 3)).to.be.equal(-4);
		expect(mat.get(3, 0)).to.be.equal(0);
		expect(mat.get(3, 1)).to.be.equal(0);
